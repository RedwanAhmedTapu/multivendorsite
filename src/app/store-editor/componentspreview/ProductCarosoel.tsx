...
export const ProductsCarousel = ({
  ...
  // Always show 4 products per slide on desktop, 2 on mobile
  const itemsPerView = viewMode === 'mobile' ? 2 : 4;
  ...
  // Mobile View Design - Horizontal Carousel
      ...
      <div className="w-full bg-white p-3">
        ...
        <div className="flex border border-gray-300 rounded-lg overflow-hidden">
          ...
          <div className="relative w-3/4 bg-white">
            ...
            <button 
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 bg-white/90 hover:bg-white shadow-lg rounded-full flex items-center justify-center transition-all -translate-x-1/2 border border-gray-200"
            >
            ...
            <div 
              ...
              className="flex gap-2 overflow-x-auto scrollbar-hide px-10 py-2 snap-x snap-mandatory"
            ...
            <button 
              onClick={nextSlide}
              className="absolute -right-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 bg-white/90 hover:bg-white shadow-lg rounded-full flex items-center justify-center transition-all border border-gray-200"
            >
  ...
  // Desktop View Design - Horizontal Carousel with 4 products per slide
      ...
      <div className="w-full bg-white p-6">
        ...
        <div className="flex border border-gray-300 rounded-xl overflow-hidden">
          ...
          <div className="relative w-3/4 bg-white">
            ...
            <button 
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white/90 hover:bg-white shadow-lg rounded-full flex items-center justify-center transition-all -translate-x-1/2 border border-gray-200"
            >
            ...
            <button 
              onClick={nextSlide}
              className="absolute -right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white/90 hover:bg-white shadow-lg rounded-full flex items-center justify-center transition-all border border-gray-200"
            >
