    ...
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-5">
                ...
                <h2 className="text-2xl font-bold text-teal-900">
                  Geepas Gp-007 Rechargeable LED Flashlight Torch Lamp - Charger
                  Light
                </h2>
                ...
                <div className="border rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex items-start gap-2 text-sm text-gray-700">
                    ...
                    <div>
                      ...
                      <button className="text-teal-700 text-xs underline mt-1">
                        Change
                      </button>
                    </div>
                  </div>
      ...
      <MoreInfoProduct
        product={{
          ...
          description: "High quality rechargeable torch with bright LED",
          price: 180,
